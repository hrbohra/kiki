...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 22, fontWeight: '800', color: color.ink },
  ...
  cardTitle: { ...font.h3 },
  subhead: { fontSize: 11, fontWeight: '800', color: color.inkSoft, marginTop: space.sm, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  whitePillText: { fontSize: 11, fontWeight: '800', color: color.textOnMint },
  ...
  author: { fontSize: 15, fontWeight: '800', color: color.ink },
  sentChip: { borderWidth: 1, borderRadius: radius.pill, paddingHorizontal: 10, paddingVertical: 4 },
  sentChipText: { fontSize: 11, fontWeight: '800', textTransform: 'capitalize' },
