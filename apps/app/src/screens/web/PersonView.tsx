...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 17, fontWeight: '800', color: color.ink },
  ...
  cardTitle: { fontSize: 17, fontWeight: '800', color: color.ink },
  ...
  eyebrow: { fontSize: 11.5, fontWeight: '800', color: color.inkSoft, textTransform: 'uppercase', letterSpacing: 0.6, marginTop: 4 },
