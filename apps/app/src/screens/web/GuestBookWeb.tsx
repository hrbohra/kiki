...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 21, fontWeight: '800', color: color.ink },
  statLabel: { fontSize: 12.5, color: color.inkFaint },
  subhead: { fontSize: 11.5, fontWeight: '800', color: color.inkSoft, textTransform: 'uppercase', letterSpacing: 0.6, marginTop: 4 },
  ...
  groupLabel: { fontSize: 11.5, fontWeight: '800', color: color.inkFaint, letterSpacing: 0.8, marginTop: 4 },
