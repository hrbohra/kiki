 ...
 *  and Sara (8/13, no note, five-night gap). */
export const ITALY_TRIP: Trip = {
  id: 'italy', name: 'Italy bday trip', icon: 'Beach', dates: '07 - 20 Jun', nights: 13, budget: 40,
  offers: [
    {
      ...
      nights: 12, total: 480, requested: '08 - 20 Jun',
    ...
    },
    {
      ...
      nights: 8, total: 320, requested: '07 - 15 Jun', note: '',
    },
  ],
};
